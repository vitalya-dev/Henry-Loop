...
draw_sprite_ext(wheel.sprite_index, wheel.image_index, x, y + 7, wheel.image_xscale, wheel.image_yscale, wheel.image_angle, wheel.image_blend, wheel.image_alpha);
draw_sprite_ext(btn_on.sprite_index, btn_on.image_index, x + 7, y + 20, btn_on.image_xscale, btn_on.image_yscale, btn_on.image_angle, btn_on.image_blend, btn_on.image_alpha);
switch (state) {
  case "OFF":
    break;
  case "TUNED":
