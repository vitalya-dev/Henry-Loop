...
timeline_moment_add_script(self.heart_rythm, timeline_max_moment(self.heart_rythm) + beat_duration, beat_off)
timeline_moment_add_script(self.heart_rythm, timeline_max_moment(self.heart_rythm) + beat_duration, beat_on)
timeline_moment_add_script(self.heart_rythm, timeline_max_moment(self.heart_rythm) + beat_duration, beat_off)
